...
IMAGE_NAME="${IMAGE_NAME:-nordicblue}"  # Fallback if not set by build env
...
sed -i "s|^CPE_NAME=\"cpe:/o:fedoraproject:fedora|CPE_NAME=\"cpe:/o:jvssdev:${IMAGE_PRETTY_NAME,}|" /usr/lib/os-release
